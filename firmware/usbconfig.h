...
#define USB_CFG_HAVE_INTRIN_ENDPOINT    0//поменял здесь 
 ...
 */
#define USB_CFG_VENDOR_NAME     'N', 'N', 'S', 'T', 'U', ' ','2', '2', '-', 'V', 'M', 'v', ' ', 'K', 'h', 'a', 'c', 'h', 'e', 'n', 'k', 'o', 'v', ' ', 'O', '.', 'I', '.', ' ', '2', '0', '2', '4'
 ...
 */
#define USB_CFG_DEVICE_NAME     'T','e','m','p','e','r','a','t','u','r','e',' ','c','o','n','t','r','o','l',' ','o','f',' ','p','o','w','e','r', ' ','T','R','M','-','0','1'
 ...
 * пару obdev VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   's', '/', 'n', ' ', '0', '0', '0', '0', '0', '1' 
